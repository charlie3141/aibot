...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        // This is for debugging purposes to see the raw output of the search tool.

        // Directly execute the search tool with the user's query
        const searchResultsArray = await googleSearchTool.search({ queries: [query] });
